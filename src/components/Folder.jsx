...
function Folder({ handleInsertNode, explorer, handleAddFileName }) {
      ...
      {explorer.isFolder ? (
        <>
          <div
            ...
            className="flex items-center justify-between w-full cursor-pointer text-gray-400 hover:text-white"
          >
        ...
        <span
          className="block mt-2 text-gray-400 cursor-pointer hover:text-white"
